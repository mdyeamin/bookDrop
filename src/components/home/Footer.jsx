      ...
      <div className="container mx-auto max-w-7xl px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm text-slate-400 max-w-md leading-relaxed">
              Your Local Library, Delivered. We connect avid readers with local libraries and independent book owners for a seamless, doorstep borrowing experience.
            </p>
            ...
            <form onSubmit={handleNewsletterSubmit} className="pt-2 flex flex-col sm:flex-row gap-3 max-w-md">
              <Input
                ...
                classNames={{
                  ...
                  inputWrapper: "bg-white/5 hover:bg-white/10 focus-within:bg-white/10 border border-white/10 rounded-xl h-12 text-white shadow-none",
          ...
          <div className="lg:col-span-3 lg:col-start-7">
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link href="/about" className="text-slate-400 hover:text-[#F46036] transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-600"></span>
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-slate-400 hover:text-[#F46036] transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-600"></span>
                  Contact Support
                </Link>
              </li>
              <li>
                <Link href="/privacy-policy" className="text-slate-400 hover:text-[#F46036] transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-600"></span>
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-slate-400 hover:text-[#F46036] transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-600"></span>
                  Terms of Service
                </Link>
              </li>
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-sm text-slate-400 mb-4">Follow us on social media for the latest updates and book recommendations.</p>
            <div className="flex gap-3">
              ...
              >
                <FaXTwitter size={16} className="text-slate-300 group-hover:text-white transition-colors" />
              </a>
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#F46036] hover:text-white transition-all border border-white/10 group"
              >
                <FaFacebookF size={16} className="text-slate-300 group-hover:text-white transition-colors" />
              </a>
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#F46036] hover:text-white transition-all border border-white/10 group"
              >
                <FaInstagram size={18} className="text-slate-300 group-hover:text-white transition-colors" />
              </a>
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#F46036] hover:text-white transition-all border border-white/10 group"
              >
                <FaLinkedinIn size={16} className="text-slate-300 group-hover:text-white transition-colors" />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-500">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden md:inline-block">Designed for avid readers everywhere.</span>
          </div>
        </div>
      </div>
    </footer>
